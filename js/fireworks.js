var Fireworks = function(){
    ...
    self.dt = 0;
		...
		self.canvasContainer = $('#intro');
		
		var canvasContainerDisabled = document.getElementById('intro1');
		self.canvas.onselectstart = function() {
			return false;
		};
		// Custom
		self.canvas.width = self.cw = self.canvasContainer[0].clientWidth;
		self.canvas.height = self.ch = self.canvasContainer[0].clientHeight;	
	...
	self.bindEvents = function(){
		...
		$(self.canvas).on('mousedown', function(e){
			...
			self.createFireworks(self.cw/2, self.ch-self.ch, self.mx, self.my);	
  ...
  */
  ...
  setInterval(function(){
	  if(document.hasFocus())
	  {
		...
		self.fireworks.push(new Firework(rand(0, self.cw), 0, rand(50, self.cw-50), rand(50, self.ch-50)));
	  }
    }, 10000);
